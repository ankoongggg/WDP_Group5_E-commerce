...
import { Layout } from '../components/Layout'; // <-- THÊM DÒNG IMPORT LAYOUT NÀY
...
const OrderHistory: React.FC = () => {
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 font-display flex flex-col pb-12">
        {selectedReviewItem && (
          <ReviewDetailModal 
        ...
        <div className="max-w-5xl mx-auto w-full px-4 pt-8 pb-4">
            <div className="flex items-center gap-2 text-sm text-slate-500">
                ...
                <Link to="/account" className="hover:text-primary transition-colors">Tài khoản</Link>
                <span className="material-symbols-outlined text-xs">chevron_right</span>
                <span className="text-primary font-bold">Đơn hàng của tôi</span>
            </div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white mt-2">Lịch sử đơn hàng</h1>
        </div>
